    ...
    <section class="home">
        <div style="padding: 2rem;">
            ...
            <table id="myTable" class="display">
                ...
                <tbody>
                    <!-- Foreach para llenar la tabla con el arrglo obtenido "datosestados" de la funcion read del modelo de estado -->
                    <?php
                foreach ($datosestados as $key => $datosestado): 
            ?>

                    <tr>
                        <th scope="row"><?php echo $datosestado['id_estado']; ?></th>
                        <td><?php echo $datosestado['nombre_estado']; ?></td>
                        <td>
                            <div>
                                ...
                                <a
                                    href="ctrlestado.php?accion=modify&id_estado=<?php echo $datosestado['id_estado']; ?>"><button
                                ...
                                <a
                                    href="ctrlestado.php?accion=delete&id_estado=<?php echo $datosestado['id_estado']; ?>"><button
