    ...
    <section class="home">
        <div style="padding: 2rem;">
            ...
            <table id="myTable" class="display">
                ...
                <thead>
                    <tr>
                        <th scope="col">ID calidad</th>
                        <th scope="col">Descripcion</th>
                        <th scope="col">Opciones</th>
                    </tr>
                </thead>
                <tbody>
                    <!-- Foreach para llenar la tabla con el arrglo obtenido "datoscalidads" de la funcion read del modelo de calidad -->
                    <?php
                foreach ($datoscalidads as $key => $datoscalidad): 
            ?>

                    <tr>
                        <th scope="row"><?php echo $datoscalidad['id_calidad']; ?></th>
                        <td><?php echo $datoscalidad['descripcion_calidad']; ?></td>
                        <td>
                            <div>
                                ...
                                <a
                                    href="ctrlcalidad.php?accion=modify&id_calidad=<?php echo $datoscalidad['id_calidad']; ?>"><button
                                ...
                                <a
                                    href="ctrlcalidad.php?accion=delete&id_calidad=<?php echo $datoscalidad['id_calidad']; ?>"><button
