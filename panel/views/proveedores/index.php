    ...
    <section class="home">
        <div style="padding: 2rem;">
            ...
            <table id="myTable" class="display">
                ...
                <tbody>
                    <!-- Foreach para llenar la tabla con el arrglo obtenido "datosproveedors" de la funcion read del modelo de proveedor -->
                    <?php
                foreach ($datosproveedors as $key => $datosproveedor): 
            ?>

                    <tr>
                        <th scope="row"><?php echo $datosproveedor['id_proveedor']; ?></th>
                        <td><?php echo $datosproveedor['nombre_proveedor']; ?></td>
                        <td><?php echo $datosproveedor['telefono_proveedor']; ?></td>
                        <td>
                            <div>
                                ...
                                <a
                                    href="ctrlproveedor.php?accion=modify&id_proveedor=<?php echo $datosproveedor['id_proveedor']; ?>"><button
                                ...
                                <a
                                    href="ctrlproveedor.php?accion=delete&id_proveedor=<?php echo $datosproveedor['id_proveedor']; ?>"><button
